...
const (
	Auth_Login_FullMethodName          = "/grpc.v1.Auth/Login"
	Auth_Register_FullMethodName       = "/grpc.v1.Auth/Register"
	Auth_GetCurrentUser_FullMethodName = "/grpc.v1.Auth/GetCurrentUser"
	Auth_RefreshToken_FullMethodName   = "/grpc.v1.Auth/RefreshToken"
)
