...
func NewLocalClient() (*LocalClient, error) {
	...
	return &LocalClient{docker: cli}, nil
}
...
func (c *LocalClient) ContainerList(ctx context.Context) ([]entity.Container, error) {
...
func (c *LocalClient) ContainerLogs(ctx context.Context, containerID, tail string) (string, error) {
	if tail == "" {
		tail = "100"
	}
...
func (c *LocalClient) ContainerExec(ctx context.Context, containerID string, cmd []string) (string, error) {
...
func (c *LocalClient) ContainerStart(ctx context.Context, containerID string) error {
...
func (c *LocalClient) ContainerStop(ctx context.Context, containerID string, timeout time.Duration) error {
	if timeout == 0 {
...
func (c *LocalClient) ContainerRestart(ctx context.Context, containerID string, timeout time.Duration) error {
	if timeout == 0 {
		timeout = 10 * time.Second
	}
	timeoutSeconds := int(timeout.Seconds())
...
func (c *LocalClient) ContainerRemove(ctx context.Context, containerID string, force bool) error {
...
func (c *LocalClient) ContainerInspect(ctx context.Context, containerID string) (*container.InspectResponse, error) {
